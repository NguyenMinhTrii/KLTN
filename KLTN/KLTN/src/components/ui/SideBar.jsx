import {
  ...
  FaCog,
  FaHome,
  FaListAlt, // Icon cho Danh sách đề tài
  FaCheckSquare, // Icon cho Xét duyệt đề tài
} from "react-icons/fa";
import Logo from "D:/KLTN-Website/KLTN/KLTN/src/images/login_background.jpg";
...
const Sidebar = ({ setSelected }) => {
  ...
  const handleTopicsClick = () => {
    ...
    setSelected("projects"); // Vẫn set "projects" khi click vào "Đề tài" cha
  };
